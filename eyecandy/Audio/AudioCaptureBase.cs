...
public abstract class AudioCaptureBase : IDisposable
{
    ...
    private AudioCaptureSyntheticData SyntheticDataGenerator;
    ...
    protected void DetectSilence()
    {
        ...
        if (UsingSyntheticData && !IsSilent)
        {
            ...
            ErrorLogging.Logger?.LogDebug($"{nameof(AudioCaptureBase)} as {GetType()}: ended synthetic data to replace silence");
        }
