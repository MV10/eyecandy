...
public abstract class AudioCaptureBase : IDisposable
{
    ...
    private CancellationTokenSource ctsSynthetic; // generated by CancellationTokenFactory
    ...
    protected AudioCaptureBase(EyeCandyCaptureConfig configuration)
    {
        ...
        if(Configuration.ReplaceSilenceAfterSeconds > 0 && this is not AudioCaptureSyntheticData)
        {
    ...
    private protected virtual void ProcessSamples()
    {
        ...
        if(IsSilent && Configuration.ReplaceSilenceAfterSeconds >= InternalBuffers.SilenceDuration.TotalSeconds)
        {
